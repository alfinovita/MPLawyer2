...
<section class="ftco-section block-23"
    ...
    <div class="container">
        <div class="row justify-content-center mt-5 mb-3s pb-5">
            <div class="col-md-10 heading-section text-center ftco-animate">
                <h2 class="mb-2">ADVOKAT PAJAK</h2>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card mb-3" style="max-width: auto; border: none">
                    <div class="card-body">
                        <div style="font-size: 14px">
                            <h5>Deskripsi</h5>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium corrupti blanditiis
                                ...
                                officiis atque aliquid. Cumque.</p>
                        </div>
                        <div style="font-size: 14px">
                            <h5>Bahasa</h5>
                            <p>Inggris</p>
    ...
    <div class="col-lg-8">
        ...
        <a href="#" class="btn btn-primary btn-lg" data-toggle="modal"
            data-target="#modal-pilih-konsultasi">Konsultasi</a>
    </div>
    </div>
    </div>
    </div> --}}
