...
<li class="nav-item has-treeview {{request()->is('user-lawyer*', 'pengajuan-lawyer*')?'active':''}}">
  ...
  <div id="collapseLawyers" class="collapse {{request()->is('user-lawyer*', 'pengajuan-lawyer*')?'show':''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
...
<li class="nav-item has-treeview {{request()->is('user-client*', 'client-konfirmasi*')?'active':''}}">
  ...
  <div id="collapseUsers" class="collapse {{request()->is('user-client*', 'client-konfirmasi*')?'show':''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
