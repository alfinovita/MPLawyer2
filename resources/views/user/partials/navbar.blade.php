  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav nav ml-auto">
        ...
        <li class="nav-item"><a href="#practice-section" class="nav-link"><span>Bidang</span></a></li>
        <li class="nav-item"><a href="#blog-section" class="nav-link"><span>Artikel</span></a></li>
        <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Kontak</span></a></li>
        <li class="nav-item "><a href="#" class="btn btn-outline-danger rounded">Logout</a></li>
      </ul>
    </div>
  </div>
</nav>