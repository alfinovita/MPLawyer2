            ...
            <div class="tab-pane fade show active py-5  bg-white " id="nav-konsultasi" role="tabpanel">
                ...
                <div class="row justify-content-center  ftco-animate">
                    <div class="col-sm m-5 ">
                        <img src="{{url('public/plugins/fronted-advokat')}}/images/icon/img_mpl_live_chat.png"
                        ...
                        <div class="row card-body py-0">
                            <div class="col-lg col-md col-sm ">
                                <div class="row justify-content-center">
                                    ...
                                    @else
                                    <img src="{{asset($k->client->avatar)}}" class="rounded-circle img-fluid"
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-6 pl-0">
                                <div class="card-body pb-0">
                                    <h5 class="card-title mb-0 font-weight-bold">{{$k->client->nama_lengkap}}</h5>
                                    <p class="text-danger">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4  my-auto ">
                                <small
                                    class="text-muted d-flex justify-content-end ">{{date('d F Y ', strtotime($k->created_at))}}</small>
                            </div>
                            <div class="row card-body pb-0">
                                <p class="m-0 text-dark pl-2">Layanan {{$k->service['nama']}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mx-auto   mt-4 mb-5 bg-white " style="max-width: auto;">
                        <div class="row card-body">
                            <div class="col-lg-10 col-md-10 col-sm-9 ">
                                <h4 class="m-0">@rupiah($t->amount)</h4>
