    ...
    <div class="container">
        <div class="row pt-5 ">
            <div class="col-lg-8 ftco-animate">
                ...
                <p class="mb-0"><span class="far fa-calendar-alt text-muted">{{date(' d F Y', strtotime($detail_artikel_saya->release_date))}} &ensp;&bull;</span> <a
                        class="text-danger px-2"> Oleh {{$detail_artikel_saya->user->nama_lengkap}}</a>
                </p>
                ...
                <div class="d-flex justify-content-between">
                    <div class="">
                        <span class="icon-heart d-flex align-items-center" href="#"> <small>&ensp;{{count($detail_artikel_saya->like)}} suka</small></span>
                    </div>
                    <div class="d-flex align-items-center">
                        <span class="icon-chat  d-flex align-items-center"><small>&ensp;{{count($detail_artikel_saya->comment)}} Komentar</small></span>
                ...
                <div class="pt-5 mt-5">
                    ...
                    @if (count($detail_artikel_saya->comment)==0)
                        <div class="row d-flex justify-content-center mt-3 mb-4 pt-4 pb-5">
                            <img src="{{url('public/plugins/fronted-advokat')}}/images/icon/img_mpl_komentar_kosong.png" class="img-fluid"
                            style="width: 6rem;">
                        </div>
                    @else
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                        <h5 class="heading artikel"><a href="{{url('advokat/artikel/'.$a->id)}}">{{$a->judul}}</a>
                            </h5>
                            <div class="meta">
                                <div><a href="#"><span class="far fa-calendar-alt"></span>{{date(' d M Y', strtotime($a->release_date))}}</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
