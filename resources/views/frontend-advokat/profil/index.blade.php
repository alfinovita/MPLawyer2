                ...
                <div class="col-md-5 mt-3 my-auto">
                    ...
                    <div class="col bg-light">
                        <div class="row align-items-center ">
                            <h5 class="font-weight-bold mx-auto pt-2" id="nama_lengkap">{{$profil->nama_lengkap}}
                    ...
                    <div class="row justify-content-center  no-gutters ">
                        <div class="col-sm ">
                            <div class="card " data-toggle="modal" data-target="#modalPendapatan">
                                ...
                                <h6 class="font-weight-bold mx-auto">@rupiah($profil->pendapatan)</h6>
                            </div>
                        </div>
                        <div class="col-sm">
                    ...
                    background-size: cover;">
                        ...
                        <div class="row no-gutters pl-3">
                            <div class="col-md-10 col-sm-10 col-9 mb-3 pl-3" style="z-index: 2;">
                                ...
                                <div class="row">
                                    <h5 class="font-weight-bold text-white ">@rupiah($profil->pendapatan)</h5>
                                </div>
                            </div>
