                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10  my-auto">
                                <div class="card-text">
                                    ...
                                    <small
                                        class="text-muted">{{date('d F Y ', strtotime($pertanyaan_detail->created_at))}}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card mx-auto  shadow-none mb-5 bg-white" style="max-width: auto;">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-11 col-md-10 col-sm-9 px-4 py-auto d-flex text-align-center">
                                            <div class="row no-gutters">  <h5 class="card-title mb-0 font-weight-bold my-auto">{{$akun->nama_lengkap}}</h5>
                                          </div>
