                ...
                <div class="inbox_chat scroll">
                    <div class="chat_list active_chat">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_1.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                                <h5>Lukman Hakin <span class="chat_date"></span></h5>
                                <p>Oke nanti saya kabari lagi</p>
                            </div>
                        </div>
                    </div>
                    <div class="chat_list">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_2.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                                <h5>Jamil Saipul</h5>
                                <p>Tolong segera kirim hasil sidang kemarin</p>
                            </div>
                        </div>
                    </div>
                    <div class="chat_list">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_3.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                                <h5>Fajar Nugroho</h5>
                                <p>Terimakasih</p>
                            </div>
                    ...
                    <div class="chat_list">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_4.jpg" class="img-msg"> </div>
                            <div class="chat_ib">
                                <h5>Boni eriko </h5>
                                <p>Berapa harganya?</p>
                            </div>
                    ...
                    <div class="chat_list">
                        <div class="chat_people">
                            ...
                            <div class="chat_ib">
                                <h5>Feri Anam</h5>
                                <p>saat ini saya sedang menghadapi kasus pembullyan yang menimpa anak saya, dapatkan anda menolong?</p>
                            </div>
                        </div>
                    </div>
                    <div class="chat_list">
            ...
            <div class="mesgs mb-2">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-4 col-6 d-flex justify-content-end">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" data-toggle="modal" data-target="#modal-somasi">Tambahkan
                                Report</a>
                            <a class="dropdown-item" href="video-conference.html">Video Conference</a>
                            <a class="dropdown-item" href="tertulis.html">Layanan Tertulis</a>
                            <a class="dropdown-item" href="pendampingan.html">Jadwal pendampingan</a>
                ...
                <div class="msg_history p-2">
                    ...
                    <div class="incoming_msg">
                        <div class="incoming_msg_img"> <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_1.jpg" class="img-msg"> </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/live-chat.blade.php ENDPATH**/ ?>