...
<section class="ftco-section">
    <div class="container">
                        ...
                        <div class="row no-gutters">
                            <div class=" row justify-content-around card-body">
                                <div class="col mx-auto my-auto pr-0">
                                    <div class="row justify-content-center">
                                        <?php if($k->lawyer->avatar == ''): ?>
                                        <img src="<?php echo e(url('public/avatar.png')); ?>" class="rounded-circle img-fluid" style="height: 100px; width: 100px;">
                                        <?php else: ?>
                                        <img src="<?php echo e(asset($k->lawyer->avatar)); ?>" class="rounded-circle img-fluid" style="height: 100px; width: 100px;" alt="...">
                                        <?php endif; ?>
                                ...
                                <div class="col-md-7 pl-0">
                                    <div class="card-body">
                                        <h5 class="card-title "><?php echo e($k->lawyer->nama_lengkap); ?></h5>
                                        <h6 class="card-text text-danger"><?php if($k->status == 'ON_GOING'): ?>
                                            Sedang Berjalan
                                            <?php elseif($k->status == 'CANCEL_CLIENT'): ?>
                                            Konsultasi Dibatalkan
                                            <?php elseif($k->status == 'FINISH_CLIENT'||'FINISH'): ?>
                                            Konsultasi Selesai
                                            <?php else: ?>
                                            <?php echo e($k->status); ?>
                                ...
                                <div class="col-md-3 my-auto">
                                    <p class="card-text text-muted text-center"><?php echo e(date('d F Y ', strtotime($k->created_at))); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="row no-gutters">
                            <div class="row card-body pt-0">
                                <div class="col mx-auto my-auto">
                                    <p class="card-title mt-0">Layanan <?php echo e($k->service['nama']); ?></p>
                ...
                <a data-toggle="modal" data-target="#modal-pertanyaan">
                    <div class="card mx-auto shadow p-0 mb-3 bg-white rounded" style="max-width: auto;">
                            ...
                            <div class=" row justify-content-around card-body">
                                <div class="col mx-auto my-auto pr-0">
                                    <div class="row justify-content-center">
                                        ...
                                        <img src="<?php echo e(url('public/avatar.png')); ?>" class="rounded-circle img-fluid" style="height: 100px; width: 100px;">
                                        <?php else: ?>
                                        <img src="<?php echo e(asset($p->user->avatar)); ?>" class="rounded-circle img-fluid" style="height: 100px; width: 100px;" alt="...">
                                        <?php endif; ?>
                                        <!-- <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_2.jpg" class="rounded-circle img-fluid" style="height: 100px; width: 100px;" alt="..."> -->
                                    </div>
                                </div>
                                <div class="col-md-7 pl-0">
                                    <div class="card-body">
                                        <h5 class="card-title m-0"><?php echo e($p->user->nama_lengkap); ?></h5>
                                        <p class="card-text text-muted"><?php echo e(date(' d M Y  H:i', strtotime($p->created_at))); ?> WIB</p>
                                    </div>
                                </div>
                                <div class="col-md-3 my-auto">
                                    <h3 class="card-text text-danger">Rp. <?php echo number_format($p->budget, 0, ',', '.'); ?>
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="row no-gutters">
                            <div class="row card-body pt-0">
                                <div class="col mx-auto my-auto">
                                    <p class="card-title mt-0">Kategori : <?php echo e($p->kategori_layanan); ?></p>
                                    <p class="shadow-none p-3 mb-0 bg-light rounded"> <?php echo e($p->judul_pertanyaan); ?>

                                    </p>
                                    <p class="text-info mt-2" style="float: right;"><?php echo e(count($p->jawaban)); ?> Lawyer Menjawab</p>
                                </div>
                            </div>
        ...
        <div class="row justify-content-center" id="div-pembayaran">
            ...
            <div class="row justify-content-center  ftco-animate">
                <div class="col-sm m-5 ">
                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/icon/img_mpl_invoice_kosong.png" alt="" class="d-block mx-auto" style="width: 30%; ">
                    <div class="row justify-content-center">
                        <div class="col-sm-5 my-3">
            ...
            <?php else: ?>
            <?php $__currentLoopData = $pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-5 col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-9 my-auto">
                                    <h2 class="card-title">Rp. <?php echo number_format($t->amount, 0, ',', '.'); ?></h2>
                                    <p class="card-title font-weight-bold">Tagihan
                                        <?php if($t->type ='MEMBERSHIP'): ?>
                                        Pengajuan Member
                                        <?php else: ?>
                                        <?php echo e($t->type); ?>

                                        <?php endif; ?></p>
                                    <p class="text-danger"> <?php if($t->status =='PAID'): ?>
                                        Sudah Dibayar
                                        <?php else: ?>
                                        Menunggu Pembayaran
                                        <?php endif; ?></p>
                ...
                <div class="col-sm-12 px-0">
                    <div class="row  ">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-4 col-6 d-flex justify-content-end">
                            <button type="button" class="btn" data-toggle="modal" data-target="#modal-detail-konsultasi-<?php echo e($k->id); ?>"><i class="fa fa-info-circle" style="font-size: 1.5rem;"></i></button>
                    ...
                    <div class="mesgs mb-2" style="width: max-content;">
                        <div class="msg_history p-2">
                            <div class="incoming_msg">
                                <div class="incoming_msg_img"> <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_2.jpg" class="img-msg">
                                </div>
...
<?php $__currentLoopData = $konsultasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="modal-detail-konsultasi-<?php echo e($k->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="card mb-3" style="max-width: auto;">
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            ...
                            <div class="col-md-10">
                                <div class="card-body">
                                    <h5 class="card-title font-weight-bold m-0"><?php echo e($k->lawyer->nama_lengkap); ?></h5>
                                    <p class="card-text"><small class="text-muted"><?php echo e(date('d F Y ', strtotime($k->created_at))); ?> WIB</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-3" style="max-width: auto;">
                    <div class="card-body">
                        ...
                        <h5 class="card-text">Layanan <?php echo e($k->service['nama']); ?></h5>
                        <br>
                        ...
                        <h5 class="card-text"> <?php if($k->status == 'ON_GOING'): ?>
                            Sedang Berjalan
                            <?php elseif($k->status == 'CANCEL_CLIENT'): ?>
                            Konsultasi Dibatalkan
                            <?php elseif($k->status == 'FINISH_CLIENT'||'FINISH'): ?>
            ...
            <div class="modal-body">
                <div class="card mb-3" style="max-width: auto;">
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            <div class="col mx-auto my-auto">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-video-confrence.png" class="rounded-circle img-fluid" style="height: 100px; width: 100px;" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document ">
        <div class="modal-content ">
            <div class="modal-body mx-3 ">
                <div class="row justify-content-center ">
                    <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon/ic-lawyer-selesai.png" style="width: 40%; ">
                </div>
                <div class="row justify-content-center ">
...
<div class="modal fade" id="modal-batal-sesi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document ">
        <div class="modal-content ">
            <div class="modal-body mx-3 ">
                <div class="row justify-content-center ">
                    <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon/ic-lawyer-batal.png" style="width: 40%; ">
                </div>
                <div class="row justify-content-center ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/riwayat.blade.php ENDPATH**/ ?>