                    ...
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            <div class="col mx-auto my-auto">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_1.jpg"
            ...
            <div class="modal-body">
                <div class="card" style="max-width: auto; border: none;">
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            <div class="col mx-auto my-auto">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/group.png"
                                    class="rounded-circle img-fluid" style="height: 100px; width: 100px;" alt="...">
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/detail-home/detail-lawyer-probono.blade.php ENDPATH**/ ?>