            ...
            <div class="row no-gutters">
                <div class="col-md-5 mt-3 my-auto">
                    <div class="row align-items-center mt-3 mb-2">
                        <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_1.jpg" class="rounded-circle img-fluid mx-auto d-block" style="height: 200px; width: 200px;" alt="...">
                    </div>
                ...
                <div class="col-sm-12 ">
                    <div class="owl-carousel carousel-bidanghukum">
                        <div class="col-sm d-flex justify-content-center ftco-animate">
                            <a href="# " class="mb-2">
                                <div class="card rounded">
                                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_divorce.jpg" class="rounded d-block m-2" style="width: 15rem;height: 15rem; " alt="... ">
                        ...
                        <div class="col-sm d-flex justify-content-center ftco-animate">
                            <a href="# " class="mb-2">
                                <div class="card rounded">
                                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_pidana.jpg" class="rounded d-block m-2 " style="width: 15rem;height: 15rem; " alt="... ">
                        ...
                        <div class="col-sm d-flex justify-content-center ftco-animate">
                            <a href="# " class="mb-2">
                                <div class="card rounded ">
                                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_hutang.jpg" class="rounded d-block m-2 " style="width: 15rem;height: 15rem; " alt="... ">
                        ...
                        <div class="col-sm d-flex justify-content-center ftco-animate">
                            <a href="# " class="mb-2">
                                <div class="card rounded">
                                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_pro_bono.jpg" class="rounded d-block m-2 " style="width: 15rem;height: 15rem; " alt="... ">
                    ...
                    background-size: cover;">
                        <div class="col">
                            <div class="row pl-3 mt-4">
                                <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/aset-card-mpl-04.png" class="rounded" style="width: 10%; height: 10%;" alt="">
                            </div>
                        ...
                        <div class="row no-gutters pl-3">
                            ...
                            <div class="col-md-2 col-sm-2  col-3 d-flex align-items-end mx-auto my-auto" style="z-index: 1; float: left;">
                                <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/aset-card-mpl-03.png" style="width: 80%; height: 80%;" class="rounded" alt="">
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/profil.blade.php ENDPATH**/ ?>