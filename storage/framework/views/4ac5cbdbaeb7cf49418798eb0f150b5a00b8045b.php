            ...
            <div class="col-md-5 col-lg-3 ftco-animate py-4 nav-link-wrap">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <div class="image col-8 mx-auto">
                        <?php if($users->avatar == ''): ?>
                        <img src="<?php echo e(url('public/avatar-default1.png')); ?>" alt="Avatar" style="height: 10rem; width: 10rem;" class="rounded-circle img-fluid mx-auto d-block">
                        <?php else: ?>
                        <img src="<?php echo e(asset($users->avatar)); ?>" alt="Avatar" style="height: 10rem; width: 10rem;" class="rounded-circle img-fluid mx-auto d-block">
                        <?php endif; ?>
                        <a href="">
                        ...
                        <!-- <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_2.jpg" class="image rounded-circle img-fluid" alt=""> -->
                        <!-- <div class="overlay">
                        ...
                        <p class="text-white text-center mt-2" id="card-nama_lengkap"><?php echo e($users->nama_lengkap); ?></p>
                        <p class="text-center mt-1 mx-auto" style="font-size: small; color: silver;">
                            <?php if($users->verified == true): ?>
                            Verified
                            <?php else: ?>
                            Belum Verified
                            <?php endif; ?></p>
                            ...
                            <form action="" method="post">
                                ...
                                <div class="col-md-12 mt-0">
                                    <div class="form-group">
                                        ...
                                        <label class="label" id="label-email" for="subject"><?php echo e($users->email); ?></label><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="label font-weight-bolder" for="subject">Nomor
                                            Telepon</label><br>
                                        <label class="label" id="label-telp" for="subject"><?php echo e($users->telp); ?></label><br>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label class="label" id="label-alamat" for="subject"><?php echo e($users->alamat); ?></label><br>
                                ...
                                <div class="col-md-12 mb-0">
                                    ...
                                    <!-- <a class="btn btn-primary" name="<?php echo e(request()->is('user-client*')); ?>" style="color:white" class="editUser" id="<?php echo e($users->id); ?>" style="float:right;" href="#" role="button" data-toggle="modal" data-target="#modal-edit">Sunting Profil</a> -->
            ...
            <div class="owl-carousel carousel-aktivitas">
                ...
                <div class="col-sm ftco-animate">
                    <div class="item " style="width: 70%;text-align: center; ">
                        <div class="aktivitas ">
                            <a href="<?php echo e(url('client/report')); ?>" style="color: #ff2424;"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-laporan.png " class="mb-2 " alt=" ">Laporan
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm ftco-animate">
                    <div class="item " style="width: 70%;text-align: center; ">
                        <div class="aktivitas ">
                            <a href="<?php echo e(url('client/pendampingan')); ?>" style="color: #ff2424;"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-pendampingan.png" class="mb-2 " alt=" ">Pendampingan
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm ftco-animate">
                    <div class="item " style="width: 70%;text-align: center; ">
                        <div class="aktivitas ">
                            <a href="<?php echo e(url('client/videoconference')); ?>" style="color: #ff2424;"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-video-confrence.png " class="mb-2 " alt=" ">Video Conference</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm ftco-animate ">
                    <div class="item " style="width: 70%;text-align: center; ">
                        <div class="aktivitas ">
                            <a href="<?php echo e(url('client/pertemuan')); ?>" style="color: #ff2424;"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-pertemuan-10.png" class="mb-2 " alt=" ">Pertemuan</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm  ftco-animate">
                    <div class="item  " style="width: 70%;text-align: center; ">
                        <div class="aktivitas ">
                            <a href="<?php echo e(url('client/tertulis')); ?>" style="color: #ff2424;"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-legal.png " class="mb-2 " alt=" ">Tertulis</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm ftco-animate">
                    <div class="item " style="width: 70%;text-align: center; ">
                        <div class="aktivitas ">
                            <a href="<?php echo e(url('client/tagihan')); ?>" style="color: #ff2424;"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-invoice-08.png" class="mb-2 " alt=" ">Tagihan</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <form id="form-update-profile">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo e($users->nama_lengkap); ?>">
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <input type="text" name="alamat" class="form-control" id="no" placeholder="Alamat" value="<?php echo e($users->alamat); ?>">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="text" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo e($users->email); ?>">
                    </div>

                    <div class="form-group">
                        <label for="no">Nomor Telepon</label>
                        <input type="text" name="telp" class="form-control" id="no" placeholder="Nomor Telepon" value="<?php echo e($users->telp); ?>">
                    </div>
                    <!-- <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/profil.blade.php ENDPATH**/ ?>