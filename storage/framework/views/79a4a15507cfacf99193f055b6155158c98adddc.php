     ...
     <tr> 
      <td valign="top"> 
                 ...
                 <tr> 
                  <td width="282" align="left"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-infoblock es-m-txt-c" align="left"><p style="font-family: arial, helvetica\ neue, helvetica, sans-serif">Support by <a href="https://can.co.id/" class="view" target="_blank" style="font-family: 'arial', 'helvetica neue', 'helvetica', 'sans-serif'">Can creative</a>  </p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table> 
               <table class="es-right" cellspacing="0" cellpadding="0" align="right"> 
                 <tr> 
                  <td width="278" align="left"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td align="right" class="es-infoblock es-m-txt-c"><p></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
       ...
       <table class="es-content" cellspacing="0" cellpadding="0" align="center"> 
         ...
         <tr> 
          <td align="center"> 
           <table class="es-header-body" style="background-color: #FF2424" width="600" cellspacing="0" cellpadding="0" bgcolor="#FF2424" align="center"> 
             <tr> 
               ...
               <table class="es-left" cellspacing="0" cellpadding="0" align="left"> 
                 <tr> 
                  <td class="es-m-p0r es-m-p20b" width="600" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-m-txt-c" align="left"><h1 style="color: #ffffff;line-height: 100%"><?php echo e($apk_name); ?></h1></td> 
                      <?php if($apk_name == 'Bursa Hukum'): ?>
                      <td align="right"><p><img width="200px" src="<?php echo e(url('public/plugins/frontend')); ?>/images/logo-bursa-hukum.png" alt=""></p></td> 
                      <?php else: ?>
                      <td align="right"><p><img width="200px" src="<?php echo e(url('public/plugins/frontend')); ?>/images/logo-bursa-advokat.png" alt=""></p></td> 
                      <?php endif; ?>
                     </tr> 
                   </table></td> 
                 </tr> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="530" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-p25t es-p25b es-p35r es-p35l" align="center" style="font-size:0"><a target="_blank" href="https://viewstripo.email/"><amp-img src="https://hksies.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/67611522142640957.png" alt style="display: block" width="120" height="115"></amp-img></a></td> 
                     </tr> 
                     <tr> 
                      <td class="es-p10b" align="center"><h2>Hai <?php echo e($nama); ?></h2><br></td> 
                     </tr> 
                     <tr> 
                      <td class="es-p15t es-p20b" align="left"><p style="font-size: 16px;color: #777777">Berikut email untuk mengganti password anda .</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                   ...
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-p10t es-p10b es-p10r es-p10l" align="left"> 
                       <table style="width: 500px" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation"> 
                         <tr> 
                          <td style="padding: 5px 10px 5px 0" width="80%" align="left">Email</td> 
                          <td style="padding: 5px 0" width="20%" align="left"><p><?php echo e($email); ?></p></td> 
                         </tr> 
                       </table>
                      </td> 
                     </tr> 
                     ...
                     Click Disini 
                      ...
                      <?php if($apk_name == 'Bursa Hukum'): ?>
                       <a type="button"  href="<?php echo e(url('client/change/'.$email.'/'.$token)); ?>">Ganti Password</a>
                      <?php else: ?>
                       <a type="button"  href="<?php echo e(url('advokat/change/'.$email.'/'.$token)); ?>">Ganti Password</a>
                      <?php endif; ?>
                     </center>
                     <tr> 
                      <td class="es-p15t es-p20b" align="left"><p style="font-size: 16px;color: #777777"><br>Pastikan hanya Anda yang mengetahui pesan email ini . Demi kenyamanan pengguna, segera lakukan login untuk mengganti password Anda.</p></td> 
                     </tr> 
                   </table>
                  </td> 
                 </tr> 
       ...
       <table class="es-content" cellspacing="0" cellpadding="0" align="center"> 
         <tr> 
          <td align="center"> 
           <table class="es-content-body" style="background-color: #FF2424" width="600" cellspacing="0" cellpadding="0" bgcolor="#FF2424" align="center"> 
             <tr> 
              <td class="es-p35t es-p35b es-p35r es-p35l" align="left"> 
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="530" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td class="es-p25t" align="left"><h2 style="color: #ffffff;font-size: 24px">Best Regard,<br><?php echo e($apk_name); ?></h2></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
               ...
               <table width="100%" cellspacing="0" cellpadding="0"> 
                 <tr> 
                  <td width="530" valign="top" align="center"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation"> 
                     <tr> 
                      <td align="left" class="es-m-txt-c es-p5b"><p style="color: #777777">If you didn't create an account using this email address, please ignore this email or&nbsp;<u><a target="_blank" style="color: #777777" class="unsubscribe">unsubscribe</a></u>.</p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
...
</html><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/emails/reset-password.blade.php ENDPATH**/ ?>