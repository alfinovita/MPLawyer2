  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav nav ml-auto">
        <li class="nav-item"><a href="<?php echo e(url('/beranda')); ?>" class="nav-link"><span>Home</span></a></li>
      ...
      <li class="nav-item"><a href="<?php echo e(url('/profil')); ?>" class="nav-link"><span>Profil</span></a></li>
        <li class="nav-item "><a href="#" class="btn rounded">Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
<?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/user/partials/navbar.blade.php ENDPATH**/ ?>