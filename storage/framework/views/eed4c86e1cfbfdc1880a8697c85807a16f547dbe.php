      ...
      <div class="row d-flex ">
          <div class="owl-carousel carousel-artikel ">
              <div class="item col-md-4 d-flex ftco-animate ">
                  <div class="card rounded mb-3">
                      <a href="artikel-detail.html">
                          <img class="card-img-top rounded-top " src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/artikel/img-artikel-2.jpg" alt="Card image cap " style="height: 300px;">
                          <div class="card-body">
              ...
              <div class="item col-md-4 d-flex ftco-animate ">
                  <div class="card rounded mb-3">
                      <a href="artikel-detail.html">
                          <img class="card-img-top rounded-top " src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/artikel/img-artikel-4.jpg" alt="Card image cap " style="height: 300px;">
                          <div class="card-body">
              ...
              <div class="item col-md-4 d-flex ftco-animate ">
                  <div class="card rounded mb-3">
                      <a href="artikel-detail.html">
                          <img class="card-img-top rounded-top " src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/artikel/img-artikel-1.jpg" alt="Card image cap " style="height: 300px;">
                          <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/artikel.blade.php ENDPATH**/ ?>