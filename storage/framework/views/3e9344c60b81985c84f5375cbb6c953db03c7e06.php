                    ...
                    <fieldset>
                        <div class="fieldset-content">
                            <ul>
                                ...
                                <li> 
                                <input type="checkbox" style="display: none" id="<?php echo e($s->id); ?>"/>
                                    <label class="pilih" for="<?php echo e($s->id); ?>">
                                        <figure class="figure">
                                            <img src="<?php echo e(asset($s->gambar)); ?>" class="d-block rounded img-fluid"
                                                style="width: 150px;height: auto;">
                                            <figcaption class="figure-caption text-center py-2 font-weight-bold">
                                                <p class="text-dark mb-0 judul"><?php echo e($s->nama); ?></p>
...
</html><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/register.blade.php ENDPATH**/ ?>