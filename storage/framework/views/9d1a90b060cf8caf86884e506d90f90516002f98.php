                        ...
                        <div class="row card-body py-0">
                            <div class="col-lg col-md col-sm ">
                                <div class="row justify-content-center">
                                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_4.jpg" class="rounded-circle img-fluid" style="height: 5rem; width: 5rem;" alt="...">
                                </div>
                            </div>
                        ...
                        <div class="mesgs mb-2" style="width: max-content;">
                            <div class="msg_history p-2">
                                ...
                                <div class="incoming_msg">
                                    <div class="incoming_msg_img"> <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_1.jpg" class="img-msg">
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/riwayat.blade.php ENDPATH**/ ?>