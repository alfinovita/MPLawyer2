                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="dept_thumb">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/layanan_probono.png" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="dept_info">
        ...
        <div class="card" style="border: none;">
            <div class="row no-gutters">
                <div class="col-md-4 justify-content-center p-3">
                    <a href="<?php echo e(url('client/detail_lawyer_probono')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/detail-home/detail-probono.blade.php ENDPATH**/ ?>