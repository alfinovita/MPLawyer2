    ...
    <div class="container">
        <div class="row justify-content-center mb-3s pb-5">
            <div class="col-md-10 heading-section text-center ftco-animate">
                <h2 class="mb-4"><?php echo e($bidang_hukum->nama); ?></h2>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4">
                            <div class="dept_thumb">
                                <img src="<?php echo e(asset($bidang_hukum->gambar)); ?>" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="dept_info">
                                <p>
                                    <?php echo e($bidang_hukum->deskripsi); ?>
...
<section class="services-section section-padding30 fix mb-5">
    <div class="container">
        <div class="row justify-content-center mt-5 mb-3s pb-5">
            <div class="col-md-10 heading-section text-center ftco-animate">
                <h2 class="mb-2">ADVOKAT BIDANG <?php echo e($bidang_hukum->nama); ?></h2>
            </div>
        </div>
        <div class="card" style="border: none;">
            <div class="row no-gutters">
                <div class="col-md-4 justify-content-center p-3">
                    <a href="<?php echo e(url('client/detail_lawyer')); ?>">
    ...
    <div class="modal-dialog modal-full-height modal-bottom" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/habis.png" style="width: 100px; height: 100px;"
                    alt="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/detail-home/detail-hukum.blade.php ENDPATH**/ ?>