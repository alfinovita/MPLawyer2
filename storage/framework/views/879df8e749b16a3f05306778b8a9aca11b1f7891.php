                    ...
                    <div class="col pb-3">
                        <div class="row">
                            <div class="col-sm p-5">
                                <?php if($tertulis_detail->client->avatar == ''): ?>
                                <img src="<?php echo e(url('public/avatar.png')); ?>" class="rounded-circle img-fluid" style="height: 125px; width:125px;" > 
                                <?php else: ?>
                                <img src="<?php echo e(asset($tertulis_detail->client->avatar)); ?>"
                                class="rounded-circle img-fluid" style="height: 125px; width:125px;" alt="...">
                                <?php endif; ?>
                            </div>
                            <div class="col-sm-10  my-auto">
                                <div class="card-text">
                                    <h5 class="font-weight-bold m-0"> <?php echo e($tertulis_detail->client->nama_lengkap); ?></h5>
                                    <small class="text-muted"><?php echo e(date(' d F Y  H:i', strtotime($tertulis_detail->created_at))); ?> WIB</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-text">
                        ...
                        <div class="col mb-2">
                            ...
                            <h6 class="font-weight-bold mx-auto mb-3">
                                Somasi <?php echo e($tertulis_detail->konsultasi->service->nama); ?>
                        ...
                        <div class="col mb-2">
                            ...
                            <h6 class="font-weight-bold mx-auto  mb-3 ">
                                <?php echo e(date('l, d F Y  H:i', strtotime($tertulis_detail->created_at))); ?> WIB
                            </h6>
                        </div>
                        <div class="col mb-2">
                            <p class="my-auto">Status</p>
                            <h6 class="font-weight-bold mx-auto">
                                <?php if($tertulis_detail->status== 'WAITING'): ?>
                                Menunggu Advokat
                                <?php elseif($tertulis_detail->status =='CONFRIM'): ?>
                                Disetujui Advokat
                                <?php elseif($tertulis_detail->status =='TOLAK'): ?>
                                Ditolak Advokat 
                                <?php elseif($tertulis_detail->status =='PAID'): ?>
                                Sudah Dibayar
                                <?php elseif($t->status ==  'WAITING_PAYMENT'): ?>
                                Menunggu Pembayaran
                                <?php else: ?>
                                <?php echo e($tertulis_detail->status); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/aktivitas/tertulis/detail.blade.php ENDPATH**/ ?>