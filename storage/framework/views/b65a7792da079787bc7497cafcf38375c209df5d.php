    ...
    <div class="container">
        <div class="row pt-5">
            <div class="col-lg-8 ftco-animate">
                ...
                <p>
                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/artikel/img-artikel-2.jpg" alt="" class="img-fluid">
                </p>
                ...
                <div class="pt-5 mt-5">
                    ...
                    <ul class="comment-list">
                        <li class="comment">
                            <div class="vcard bio">
                                <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_1.jpg" alt="Image placeholder">
                            </div>
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url(<?php echo e(URL('/')); ?>/public/plugins/fronted-advokat/images/image_1.jpg);"></a>
                        <div class="text">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url(<?php echo e(URL('/')); ?>/public/plugins/fronted-advokat/images/image_2.jpg);"></a>
                        <div class="text">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url(<?php echo e(URL('/')); ?>/public/plugins/fronted-advokat/images/image_3.jpg);"></a>
                        <div class="text">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/detail-artikel.blade.php ENDPATH**/ ?>