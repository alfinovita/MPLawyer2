...
<link rel="stylesheet" href="<?php echo e(url('public/plugins/frontend')); ?>/css/chat_konsultasi.css" />
                ...
                <div class="inbox_chat scroll">
                    ...
                    <div class="chat_list">
                        <div class="chat_people">
                            <div class="chat_img"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_1.jpg"
                                    class="img-msg" /></div>
                            <div class="chat_ib">
                                <h5><?php echo e($k->lawyer->nama_lengkap); ?><span class="chat_date"></span></h5>
...
<div class="mesgs mb-2">
    ...
    <div class="msg_history p-2">
        ...
        <div class="incoming_msg">
            <div class="incoming_msg_img"><img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_1.jpg"
                    class="img-msg" /></div>
                    ...
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            <div class="col-md-3 mx-auto my-auto">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_4.jpg" class="rounded-circle"
        ...
        <div class="modal-content">
            <div class="modal-body mx-3">
                <div class="row justify-content-center">
                    <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/setuju.png" style="width: 40%" />
                </div>
                <div class="row justify-content-center">
...
<div class="modal fade" id="modal-batal-sesi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true ">
    <div class="modal-dialog" role="document ">
        <div class="modal-content">
            <div class="modal-body mx-3">
                <div class="row justify-content-center">
                    <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/tolak.png" style="width: 40%" />
                </div>
                <div class="row justify-content-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app-chat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/chat.blade.php ENDPATH**/ ?>