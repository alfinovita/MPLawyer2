                ...
                <div class="inbox_chat scroll">
                    ...
                    <div class="chat_list ">
                        <div class="chat_people">
                            ...
                            <div class="chat_ib">
                                <h5><?php echo e($k->client->nama_lengkap); ?> <span class="chat_date"></span></h5>
                            <p><?php echo e($k->chat); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-4 col-6 d-flex justify-content-end">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" data-toggle="modal" data-target="#modal-somasi">Tambahkan
                                Report</a>
                            <a class="dropdown-item" href="<?php echo e(url('advokat/tertulis')); ?>">Video Conference</a>
                            <a class="dropdown-item" href="<?php echo e(url('advokat/video-conference')); ?>">Layanan Tertulis</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-chat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/aktivitas/livechat/index.blade.php ENDPATH**/ ?>