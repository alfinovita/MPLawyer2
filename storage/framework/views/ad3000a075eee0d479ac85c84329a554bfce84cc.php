...
<section class="hero-wrap js-fullheight" style="background-image: url(<?php echo e(URL('/')); ?>/public/plugins/fronted-advokat/images/event3.jpg)" data-section="home">
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url(<?php echo e(URL('/')); ?>/public/plugins/fronted-advokat/images/img/event/img-event-1.jpg)"></a>
                        <div class="text">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url(<?php echo e(URL('/')); ?>/public/plugins/fronted-advokat/images/event2.jpg)"></a>
                        <div class="text">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url(<?php echo e(URL('/')); ?>/public/plugins/fronted-advokat/images/event5.jpg)"></a>
                        <div class="text">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/detail-event.blade.php ENDPATH**/ ?>