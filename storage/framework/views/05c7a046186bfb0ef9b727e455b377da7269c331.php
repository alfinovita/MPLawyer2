    ...
    <div class="container mt-5 pt-5 ">
        <div class="row justify-content-center my-5">
            <div class="col-md-10  text-center ftco-animate">
                <h2 class="pb-4 font-weight-bold">Riwayat</h2>
            </div>
        </div>
        <nav>
            <div class="nav nav-tabs " id="nav-tab">
                <a class="nav-item nav-link active font-weight-bold" id="nav-konsultasi-tab" data-toggle="tab"
                    href="#nav-konsultasi" role="tab" style="width: 50%; ">Konsultasi</a>
                <a class="nav-item nav-link font-weight-bold" id="nav-pembayaran-tab" data-toggle="tab" href="#nav-pembayaran"
                    role="tab" style="width: 50%;">Pembayaran</a>
            </div>
        </nav>
        <div class="tab-content  " id="nav-tabContent">
            ...
            <div class="tab-pane fade show active py-5  bg-white " id="nav-konsultasi" role="tabpanel">
                ...
                <div class="row justify-content-center  ftco-animate">
                    <div class="col-sm m-5 ">
                        <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/icon/img_mpl_live_chat.png"
                ...
                <div class=" mx-3 my-2">
                    <div class="card mx-auto  p-3 mt-4 mb-5 " style="max-width: auto;" data-toggle="modal"
                        data-target="#modal-konsultasi">
                        <div class="row card-body py-0">
                            <div class="col-lg col-md col-sm ">
                                <div class="row justify-content-center">
                                    <?php if($k->client->avatar == ''): ?>
                                    <img src="<?php echo e(url('public/avatar.png')); ?>" class="rounded-circle img-fluid"
                                        style="height: 5rem; width: 5rem;">
                                    <?php else: ?>
                                    <img src="<?php echo e(asset($k->client->avatar)); ?>" class="rounded-circle img-fluid"
                            ...
                            <div class="col-lg-8 col-md-7 col-sm-6 pl-0">
                                <div class="card-body pb-0">
                                    <h5 class="card-title mb-0 font-weight-bold"><?php echo e($k->client->nama_lengkap); ?></h5>
                                    <p class="text-danger">
                                        <?php if($k->status == 'ON_GOING'): ?>
                                        Sedang Berjalan
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4  my-auto ">
                                <small
                                    class="text-muted d-flex justify-content-end "><?php echo e(date('d F Y ', strtotime($k->created_at))); ?></small>
                            </div>
                            <div class="row card-body pb-0">
                                <p class="m-0 text-dark pl-2">Layanan <?php echo e($k->service['nama']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- content Pembayarn -->
            <div class="tab-pane fade bg-white py-5" id="nav-pembayaran" role="tabpanel">
                    ...
                    <div class="card mx-auto   mt-4 mb-5 bg-white " style="max-width: auto;">
                        <div class="row card-body">
                            <div class="col-lg-10 col-md-10 col-sm-9 ">
                                <h4 class="m-0">Rp. <?php echo number_format($t->amount, 0, ',', '.'); ?></h4>
                                <small><strong> Tagihan
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-4 col-6 d-flex justify-content-end">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" data-toggle="modal" data-target="#modal-somasi">Tambahkan
                                    Report</a>
                                <a class="dropdown-item" href="<?php echo e(url('advokat/video-conference')); ?>">Video Conference</a>
                                <a class="dropdown-item" href="<?php echo e(url('advokat/tertulis')); ?>">Layanan Tertulis</a>
                                <a class="dropdown-item" href="<?php echo e(url('advokat/pendampingan')); ?>">Jadwal pendampingan</a>
                        ...
                        <div class="msg_history p-2">
                            ...
                            <div class="incoming_msg">
                                <div class="incoming_msg_img"> <img
                                        src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_1.jpg"
                                        class="img-msg">
                                </div>
                    ...
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            <div class="col-md-3 mx-auto my-auto">
                                <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_4.jpg"
                                    class="rounded-circle " style="height: 100px; width: 100px;" alt="...">
                            </div>
                            <div class="col-md">
                                <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <button type="button" class="btn btn-primary btn-block"><a href="#" style="color: white;">Kirim</a>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content ">
            <div class="modal-body mx-3 ">
                <div class="row justify-content-center pt-3">
                    <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/icon/ic-lawyer-selesai.png " style="width: 40%; ">
                </div>
                <div class="row justify-content-center ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/riwayat/index.blade.php ENDPATH**/ ?>