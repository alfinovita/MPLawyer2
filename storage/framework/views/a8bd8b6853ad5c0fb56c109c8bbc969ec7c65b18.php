        ...
        <div class="row justify-content-center pb-3 mx-3 ftco-animate">
                ...
                <div class="row no-gutters">
                    <div class="row justify-content-around card-body py-0">
                        <div class="col mx-auto my-auto pr-0">
                            <div class="row justify-content-center">
                                <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_divorce.jpg" class="rounded img-fluid" style="height: 5rem; width: 5rem;" alt="...">
                            </div>
                        </div>
            ...
            <div class="card p-3 my-2 mx-4 bg-white rounded" style="max-width: auto;">
                <div class="row card-body py-0">
                    <div class="col mx-auto my-auto pr-0">
                        <div class="row justify-content-center">
                            <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_pidana.jpg" class="rounded img-fluid" style="height: 5rem; width: 5rem;" alt="...">
                        </div>
                    </div>
            ...
            <div class="card p-3 my-2 mx-4 bg-white rounded" style="max-width: auto;">
                <div class="row no-gutters">
                    <div class="row justify-content-around card-body py-0">
                        <div class="col mx-auto my-auto pr-0">
                            <div class="row justify-content-center">
                                <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_hutang.jpg" class="rounded img-fluid" style="height: 5rem; width: 5rem;" alt="...">
                            </div>
                        </div>
                        <div class="col-md-8 pl-0">
                            <div class="card-body pb-0 mx-2">
              ...
              <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body m-2">
                    <div class="row px-3 mb-3">
                        <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/img/probono/img_contract.jpg" class="rounded img-fluid" style="height: 7rem; width: 7rem;" alt="...">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/bidang-hukum.blade.php ENDPATH**/ ?>