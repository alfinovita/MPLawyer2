...
<link rel="stylesheet" href="<?php echo e(url('public/plugins/frontend')); ?>/css/chat.css" />
                ...
                <div class="card" style="max-width: auto; border: none">
                    <div class="row no-gutters">
                        <div class="row card-body">
                            <div class="col-md-3">
                                <?php if($detail_advokat_online->avatar == ''): ?>
                                ...
                                <?php else: ?>
                                <img src="<?php echo e(asset($detail_advokat_online->avatar)); ?>" alt=""
                                    style="border-radius: 50%;" width="220px" height="220px" />
                                <?php endif; ?>
                            </div>
                            <div class="col-md-8 mt-4">
                                <div class="card-body">
                                    <h3><strong><?php echo e($detail_advokat_online->nama_lengkap); ?></strong></h3>
                                    <p style="color: #ff2424; margin-top: 5px;">
                                        <?php echo e($detail_advokat_online->lawyer_detail->gelar); ?></p>
                ...
                <div class="card mb-3" style="max-width: auto; border: none">
                    <div class="card-body">
                        <div style="font-size: 14px">
                            <h5>Deskripsi</h5>
                            <p><?php echo e($detail_advokat_online->lawyer_detail->bio); ?></p>
                        </div>
                        <div style="font-size: 14px">
                            <h5>Bahasa</h5>
                            <p><?php echo e($detail_advokat_online->lawyer_detail->bahasa); ?></p>
                        </div>
                        <div style="font-size: 14px">
                            <h5>Domisili</h5>
                            <p><?php echo e($detail_advokat_online->lawyer_detail->kota); ?>,
                                <?php echo e($detail_advokat_online->lawyer_detail->provinsi); ?></p>
                        </div>
        ...
        <div class="card" style="width: 100%; border: none;">
            <div class="card-body">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-2">
                        <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_1.jpg" alt=""
            ...
            <div class="modal-body">
                <div class="row" style="font-size: 16px;">
                    <div class="col" style="color: black;">
                        <?php $__currentLoopData = $detail_bidang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" class="btn btn-light btn-block text-left"><?php echo e($m->nama); ?></button>
                    ...
                    <div class="mesgs mb-2" style="width: max-content;">
                        ...
                        <div class="msg_history p-2">
                            ...
                            <div class="d-flex justify-content-center mt-5 mb-3">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon/img_mpl_live_chat.png"
                                    style="width: 40%;">
                            </div>
                    ...
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            <div class="col mx-auto my-auto">
                                <img src="<?php echo e(asset($detail_advokat_online->avatar)); ?>" class="rounded-circle img-fluid"
                                    style="height: 100px; width: 100px;" alt="...">
                            </div>
                            <div class="col-md-10">
                                <div class="card-body">
                                    <h5 class="card-title font-weight-bold m-0">
                                        <?php echo e($detail_advokat_online->nama_lengkap); ?></h5>
            ...
            <div class="modal-body">
                <div class="card mb-3" style="max-width: auto">
                    <div class="row no-gutters">
                        <div class="row justify-content-around card-body">
                            <div class="col mx-auto my-auto">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon-lawyer-video-confrence.png"
        ...
        <div class="modal-content">
            <div class="modal-body mx-3">
                <div class="row justify-content-center">
                    <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/icon/ic-lawyer-selesai.png"
                        style="width: 40%" />
                </div>
                <div class="row justify-content-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/detail-home/detail-lawyer-online.blade.php ENDPATH**/ ?>