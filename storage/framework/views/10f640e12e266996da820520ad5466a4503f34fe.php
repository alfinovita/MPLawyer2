...
<section class="hero-wrap js-fullheight"
  style="background-image:url(<?php echo e(URL('/')); ?>/public/plugins/frontend/images/bg-5.png)" data-section="home">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="owl-carousel carousel-iklan">
          <?php $__currentLoopData = $slider_client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="report-module">
            <div class="thumbnail">
              <a href="<?php echo e(url('client/detail_client/'.$a->id)); ?>"><img src="<?php echo e(asset($a->image)); ?>" /></a>
            </div>
          </div>
...
<!-- Start Pemberitahuan -->
<section class="ftco-section" style="padding-top: 25px; padding-bottom: 0;">
  <div class="container">
    ...
    <div class="ftco-animate">
      ...
      <div class="alert" style="background-color: #ffeeec;">
        <div class="d-flex">
          <div class="p-2">Tagihan Pengajuan Somasi Dikirimkan Oleh Advokat Andira Pramanta</div>
          <div class="ml-auto p-2" style="color: #ff2424"><i class="fa fa-bell" style="font-size: 22px"
...
<section class="ftco-section ftco-no-pb ftco-services" style="padding-top: 25px; padding-bottom: 0;">
  <div class="container">
    <div class="row justify-content-center pb-4">
      <div class="col-md-10 heading-section text-center ftco-animate">
      ...
      <div class="col-md-12">
        <div class="owl-carousel carousel-bidang mb-5">
          ...
          <div class="post-slide4">
            <?php if($l->id == 4): ?>
            <a href="<?php echo e(url('client/detail_probono/')); ?>">
              <?php elseif($l->id == 5): ?>
              <a href="<?php echo e(url('client/legalitas/')); ?>">
                <?php elseif($l->id == 6): ?>
                <a href="#modal-invoice" data-toggle="modal" data-target="#modal-invoice">
                  <?php elseif($l->id == 8): ?>
                  <a href="<?php echo e(url('client/peraturan/')); ?>">
                    <?php elseif($l->id == 7): ?>
                    <a href="#modal-kantor" data-toggle="modal" data-target="#modal-kantor">
                      <!-- <a href="<?php echo e(url('client/kantor/')); ?>"> -->

                      <?php endif; ?>

                      <div class="post-img">
                        <img src="<?php echo e(asset($l->image)); ?>" alt="" />
                      </div>
                    </a>
                    <div class="post-content">
                      <h3 class="post-title"><?php echo e($l->nama); ?></h3>
                    </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<!-- Start Live Chat -->
<section class="ftco-section" style="padding-top: 10px; padding-bottom: 0;">
  <div class="container">
    <div class="row justify-content-center pb-4">
      <div class="col-md-10 heading-section text-center ftco-animate">
    ...
    <div class="row justify-content-center">
        ...
        <div class="card-body">
          <div class="row text-center justify-content-center">
            <div class="text d-flex align-items-center">
              <span class="position" style="font-size: 20px"><?php echo e($jumlah_advokat_online); ?> Advokat Online saat ini</span>
            </div>
          </div>
          <hr style="width: 50%;">
          <div class="row justify-content-center mt-5 mb-3" style="padding-left: 70px;">
            <?php $__currentLoopData = $advokat_online; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($a->status_app == true): ?>
                ...
                <div class="staff" style="margin-bottom: 20px;">
                  <div class="img-wrap d-flex align-items-stretch">
                    ...
                    <div class="img align-self-stretch"
                      style="background-image:url(<?php echo e(URL('/')); ?>/public/plugins/frontend/images/img_profil_default.png); border: solid 4px #fff;">
                    </div>
                    <?php else: ?>
                    <div class="img align-self-stretch"
                      style="background-image:url('<?php echo e(asset($a->avatar)); ?>'); border: solid 4px #fff;"></div>
                    <?php endif; ?>
                  </div>
            </div>
          </div>
      ...
      <a href="<?php echo e(url('client/live_chat')); ?>" class="btn btn-primary btn-lg btn-block">Lihat Advokat Online</a>
    </div>
  </div>
  </div>
  </div>
...
<!-- Start App -->
<section class="ftco-section" style="padding-top: 70px; padding-bottom: 70px;">
  <div class="container">
    <div class="row justify-content-center">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-sm-2 text-center">
              <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/logo-bursa-hukum.png" alt=""
...
<!-- Start Bidang Hukum -->
<section class="ftco-section ftco-no-pb ftco-services" style="padding-top: 10px; padding-bottom: 0;">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12 ftco-animate">
        <div class="owl-carousel carousel-bidang mb-5">
          <?php $__currentLoopData = $bidang_hukum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="post-slide4">
            <a href="<?php echo e(url('client/detail_hukum/'.$h->id)); ?>">
              <div class="post-img">
                <img src="<?php echo e(asset($h->gambar)); ?>" alt="" />
              </div>
            </a>

            <div class="post-content">
              <h3 class="post-title"><?php echo e($h->nama); ?></h3>
            </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-md-12 ftco-animate">
      <div class="owl-carousel carousel-testimony">
        ...
        <div class="post-slide2" style="height: 350px;">
          <div class="post-img">
            <a href="<?php echo e(url('client/detail_artikel/'.$a->id)); ?>"><img class="card-img-top" src="<?php echo e(asset($a->image)); ?>"
                alt="" style="height: 200px;" /></a>
          </div>
          <div class="post-content">
            <h3 class="post-title"><a href="<?php echo e(url('client/detail_artikel')); ?>"><?php echo e($a->judul); ?></a></h3>
            <ul class="post-bar">
              <li style="font-size: 14px"><i class="icon-calendar"></i><?php echo e(date(' d M Y', strtotime($a->release_date))); ?>
...
<!-- Start Event -->
<section class="ftco-section" style="padding-top: 40px; padding-bottom: 0;">
  <div class="container">
    <div class="row justify-content-center mb-3s pb-5">
      <div class="col-md-10 heading-section text-center ftco-animate">
      ...
      <div class="col-md-12 ftco-animate">
        <div class="owl-carousel carousel-event-client">
          ...
          <div class="post-slide2">
            <div class="post-img">
              <a href="<?php echo e(url('client/detail_event/'.$m->id)); ?>"><img class="card-img-top" src="<?php echo e(asset($m->gambar)); ?>"
                  alt="" style="height: 250px;" /></a>
            </div>
            <div class="post-content">
              <h3 class="post-title"><a href="<?php echo e(url('client/detail_event')); ?>"><?php echo e($m->nama); ?></a></h3>
              <ul class="post-bar">
                <li style="font-size: 14px"><i class="icon-calendar"></i><?php echo e(date(' d M Y', strtotime($m->tanggal))); ?></li>
              </ul>
...
<!-- Start Slider Iklan -->
<section class="ftco-section" style="padding-top: 10px; padding-bottom: 40px;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="owl-carousel carousel-iklan">
          <?php $__currentLoopData = $slider_iklan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="report-module">
            <div class="thumbnail">
              <a href="<?php echo e(url('client/detail_iklan/'.$p->id)); ?>"><img src="<?php echo e(asset($p->image)); ?>" /></a>
            </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/home.blade.php ENDPATH**/ ?>