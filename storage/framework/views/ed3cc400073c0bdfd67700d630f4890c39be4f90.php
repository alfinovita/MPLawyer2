    ...
    <div class="container">
        <div class="row justify-content-center my-5">
            <div class="col-md-10 text-center ftco-animate">
                <h2 class="pb-4 font-weight-bold">Pertemuan</h2>
            </div>
        </div>
        <?php if($pertemuan->isEmpty()): ?>
        ...
        <a href="<?php echo e(url('advokat/pertemuan/'.$p->id)); ?>">
                    ...
                    <div class="row card-body py-0">
                        ...
                        <div class="col-lg-8 col-md-7 col-sm-6 pl-0">
                            <div class="card-body pb-0">
                                <h5 class="card-title mb-0 font-weight-bold"><?php echo e($p->nama); ?></h5>
                                <p class="text-info">
                                    <?php if($p->status== 'WAITING'): ?>
                                    Menunggu Advokat
                                    <?php elseif($p->status =='CONFIRM'): ?>
                                    Disetujui Advokat
                        ...
                        <div class="col-lg-3 col-md-3 my-auto ">
                            <small class="text-muted d-flex justify-content-end "><?php echo e(date('d F Y ', strtotime($p->created_at))); ?></small>
                        </div>
                        <div class="row card-body pb-0">
                            <?php if($p['konsultasi']->service_id == 0): ?>
                            <p class="m-0 text-dark pl-2">Pertemuan Probono </p>
                            <?php else: ?>
                            <p class="m-0 text-dark pl-2">Pertemuan <?php echo e($p['konsultasi']->service['nama']); ?></p>  
                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/aktivitas/pertemuan/index.blade.php ENDPATH**/ ?>