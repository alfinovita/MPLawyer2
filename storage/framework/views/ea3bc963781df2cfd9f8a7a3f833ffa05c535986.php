  ...
  <div class="main ">
    <div class="col-lg-4 col-md-5 col-sm-6 mx-auto my-auto">
      <div class="card mt-5">
        ...
        <form action="<?php echo e(url('client/login')); ?>" class="p-5 mx-3" method="post">
          <?php echo csrf_field(); ?>
          <?php if($errors->any()): ?>
          ...
          <div class="form-group text-right">
            <small class="text-right"><a href="<?php echo e(url('client/forget')); ?>">Lupa Password ?</a></small>
          </div>
          <div class="form-group">
          ...
          <div class="form-group text-center">
            <small>
              Belum punya Akun?<a href="<?php echo e(url('client/register')); ?>"> Daftar</a>
            </small>
          </div>
        </form>
      </div>
...
</html><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/login.blade.php ENDPATH**/ ?>