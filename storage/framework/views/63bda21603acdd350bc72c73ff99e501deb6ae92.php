...
<body
  ...
  <div class="main ">
    <div class="col-lg-4 col-md-5 col-sm-6 mx-auto my-auto">
      <div class="card mt-5">
        <h2 class="pb-3  ">Bursa Advokat</h2>
        <form action="<?php echo e(url('advokat/reset-password')); ?>" class="p-5 mx-3" method="post">
          <?php echo csrf_field(); ?>
          <?php if($errors->any()): ?>
...
</html><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/reset-password.blade.php ENDPATH**/ ?>