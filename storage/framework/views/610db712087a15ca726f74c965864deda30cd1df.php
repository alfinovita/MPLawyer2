...
<section class="ftco-section ">
        ...
        <div class="row justify-content-center pb-3 ftco-animate">
            <div class="col-md-12 col-lg-12">
                <a href="<?php echo e(url('advokat/pertanyaan/detail')); ?>">
                            ...
                            <div class="row  card-body py-0">
                                <div class="col mx-auto my-auto pr-0">
                                    <div class="row justify-content-center">
                                        <img src="<?php echo e(url('public/plugins/fronted-advokat')); ?>/images/person_1.jpg" class="rounded-circle img-fluid" style="height: 5rem; width: 5rem;" alt="...">
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/pertanyaan.blade.php ENDPATH**/ ?>