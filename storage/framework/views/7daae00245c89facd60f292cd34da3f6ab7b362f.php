...
<body style="background: 
  ...
  <div class="">
    <div class="col-lg-4 col-md-5 col-sm-6 mx-auto my-auto">
      ...
      <div class="card mt-5">
        <h2 class="pb-3 pt-4 mx-auto">Bursa Advokat</h2>
        <form action="<?php echo e(url('advokat/login')); ?>" class="p-5 mx-3" method="post">
          <?php echo csrf_field(); ?>
          <?php if($errors->any()): ?>
        ...
        <?php endif; ?>
          ...
          <div class="form-group text-right">
            <small class="text-right"><a href="">Lupa Password ?</a></small>
          </div>
          <div class="form-group">
            <button type="submit" class="btn btn-lg btn-primary btn-block font-weight-bold " role="button">Masuk</button>
          </div>
          <div class="form-group text-center">
            <small>
              Belum punya Akun?<a href="<?php echo e(url('advokat/register')); ?>"> Daftar</a>
            </small>
          </div>
        </form>
      </div>
