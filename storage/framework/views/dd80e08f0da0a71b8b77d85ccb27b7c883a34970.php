                    ...
                    <div class="col pb-3">
                        <div class="row">
                            <div class="col-sm p-5">
                                <?php if($pertemuan_detail->client->avatar == ''): ?>
                                <img src="<?php echo e(url('public/avatar.png')); ?>" class="rounded-circle "style="height: 125px; width:125px;"> 
                                <?php else: ?>
                                <img src="<?php echo e(asset($pertemuan_detail->client->avatar)); ?>" class="rounded-circle " style="height: 125px; width:125px;" alt="...">
                                <?php endif; ?>
                            </div>
                          <div class="col-sm-10  my-auto">
                                <div class="card-text">
                                    <h5 class="font-weight-bold m-0"><?php echo e($pertemuan_detail->client->nama_lengkap); ?></h5>
                                    <small class="text-muted"><?php echo e(date('d F Y  H:i', strtotime($pertemuan_detail->created_at))); ?> WIB</small>
                    ...
                    <div class="card-text">
                        ...
                        <div class="col mb-2">
                            ...
                            <h6 class="font-weight-bold mx-auto mb-3">
                                <?php if($pertemuan_detail['konsultasi']->service_id == 0): ?>
                                <p class="m-0 text-dark ">Pertemuan Probono </p>
                                <?php else: ?>
                                <p class="m-0 text-dark ">Pertemuan <?php echo e($pertemuan_detail['konsultasi']->service['nama']); ?></p>  
                                <?php endif; ?>
                            </h6>
                        </div>
                        <div class="col mb-2">
                            ...
                            <h6 class="font-weight-bold mx-auto  mb-3 ">
                                <?php echo e(date('l, d F Y  H:i', strtotime($pertemuan_detail->created_at))); ?> WIB
                            </h6>
                        </div>
                        <div class="col mb-2">
                            <p class="my-auto">Status</p>
                            <h6 class="font-weight-bold mx-auto">
                                    <?php if($pertemuan_detail->status== 'WAITING'): ?>
                                    Menunggu Advokat
                                    <?php elseif($pertemuan_detail->status =='CONFIRM'): ?>
                                    Disetujui Advokat
                                    <?php elseif($pertemuan_detail->status =='TOLAK'): ?>
                                    Ditolak Advokat Dengan Alasan "<?php echo e($pertemuan_detail->alasan_tolak); ?>"
                                    <?php elseif($pertemuan_detail->status =='PAID'): ?>
                                    Sudah Dibayar
                                    <?php elseif($pertemuan_detail->status ==  'WAITING_PAYMENT'): ?>
                                      Menunggu Pembayaran
                                    <?php else: ?>
                                    <?php echo e($pertemuan_detail->status); ?>
                        ...
                        <div class="col mt-4 ">
                            ...
                            <div class="col mb-2">
                                ...
                                <h6 class="font-weight-bold mx-auto  mb-3 ">
                                    <?php echo e($pertemuan_detail->alasan_tolak); ?> 
                                </h6>
                            </div>
                            <?php endif; ?> 
            ...
            <div class="modal-content ">
                <div class="modal-body mx-3 ">
                    ...
                    <div class="row mb-3 ">
                        ...
                        <div class="col-sm ">
                        <a class="btn btn-primary btn-block font-weight-bold my-2 " href="<?php echo e(url('advokat/buat-tagihan')); ?>">
                                Setujui </a>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend-advokat.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-advokat/aktivitas/pertemuan/detail.blade.php ENDPATH**/ ?>