    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                ...
                <div style="font-size: 16px"><span class="icon-calendar"></span> <?php echo e(date(' d M Y', strtotime($artikel->release_date))); ?> &bull;<span class="icon-person"></span> Oleh <?php echo e($artikel->user->nama_lengkap); ?></div>
                ...
                <div class="pt-5 mt-5">
                    ...
                    <ul class="comment-list">
                        <li class="comment">
                            <div class="vcard bio">
                                <img src="<?php echo e(url('public/plugins/frontend')); ?>/images/person_1.jpg" alt="Image placeholder" />
                            </div>
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            <h3 class="heading"><a href="#"><?php echo e($a->judul); ?></a>
                            </h3>
                            <div class="meta">
                                <div>
                                    <a href="#"><span class="icon-calendar"></span> <?php echo e(date(' d M Y', strtotime($a->release_date))); ?></a>
                                </div>
                                <div>
...
<?php echo $__env->make('frontend-client.layouts.app-putih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/idaman.org/public_html/lawyer/resources/views/frontend-client/detail-home/detail-artikel.blade.php ENDPATH**/ ?>